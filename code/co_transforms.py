...
class ToPILImage(object):
    ...
    def __call__(self, pic, target):
        ...
        """
        return F.to_pil_image(pic, self.mode), F.to_pil_image(target, self.mode)
...
class Resize(object):
    ...
    def __call__(self, img, target):
        ...
        """
        return F.resize(img, self.size, self.interpolation), F.resize(target, self.size, self.interpolation)
